import { addDependenciesToPackageJson, generateFiles, installPackagesTask, joinPathFragments, readProjectConfiguration, updateProjectConfiguration } from "@nrwl/devkit";
...
function updateTestTarget(tree, projectConfiguration, projectName, projectTargets = ["test"]) {
